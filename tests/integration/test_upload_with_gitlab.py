...
@patch('cap.modules.git.gitlab_api.Gitlab')
def test_upload_when_repo_and_creating_push_webhook(m_gitlab, client, deposit,
                                               auth_headers_for_superuser,
                                               json_headers, git_repo_tar):
...
@patch('cap.modules.git.gitlab_api.generate_secret',
       Mock(return_value='mysecret'))
@patch('cap.modules.git.gitlab_api.Gitlab')
def test_upload_when_repo_and_creating_release_webhook(m_gitlab, client, deposit,
                                               auth_headers_for_superuser,
                                               json_headers, git_repo_tar):
    current_app.config['DEBUG'] = False

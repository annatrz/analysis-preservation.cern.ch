...
from cap.modules.git.errors import GitURLParsingError
from cap.modules.git.factory import create_git_api
from cap.modules.git.utils import parse_git_url
...
@mark.parametrize("url,parsed", [
    ('https://github.com/cap/test-repo',
     ('github.com', 'cap', 'test-repo', None, None, None)),
    ...
    ('https://gitlab.cern.ch/pfokiano/test-repo/blob/test-branch/dir/file.txt',
     ('gitlab.cern.ch', 'pfokiano', 'test-repo', 'test-branch', 'dir/file.txt',
      'file.txt')),

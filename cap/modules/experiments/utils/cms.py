...
from ..search.cms_triggers import CMS_TRIGGERS_ES_CONFIG, CMSTriggerSearch
...
def validate_cms_trigger(trigger, dataset='', year=None):
    search = CMSTriggerSearch().exact_search(trigger, dataset, year)
